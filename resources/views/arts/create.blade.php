    ...
    <div class="main-show-art ">
        <div class="form-table">
            ...
            <div class="form-separation">
                ...
                {!! Form::text('slug', null, ['class' => 'form-control form-text', 'placeholder' => 'Input the title of the movie or TVShow']) !!}
                @error('slug')
                <span class="form-text-danger">{{$message}}</span>
                @enderror
            </div>
            ...
            <div class="form-separation">
                ...
                {!! Form::number('year', null, ['class' => 'form-control form-number', 'placeholder' => 'Input the title of the movie or TVShow']) !!}
                @error('year')
                <span class="form-text-danger">{{$message}}</span>
                @enderror
            </div>
            ...
            <div class="form-separation">
                ...
                {!! Form::date('releaseDate', null, ['class' => 'form-control form-date', 'placeholder' => 'Input the title of the movie or TVShow']) !!}
                @error('releaseDate')
                <span class="form-text-danger">{{$message}}</span>
                @enderror
            </div>
            ...
            <div class="form-separation">
                ...
                {!! Form::number('duration', null, ['class' => 'form-control form-number', 'placeholder' => 'Input the title of the movie or TVShow']) !!}
                @error('duration')
                <span class="form-text-danger">{{$message}}</span>
                @enderror
            </div>
            ...
            <div class="form-separation">
                ...
                {!! Form::textarea('plot', null, ['rows' => 4,'cols' => 54,'class' => 'form-control form-textarea', 'placeholder' => 'Input the title of the movie or TVShow']) !!}
                @error('plot')
                <span class="form-text-danger">{{$message}}</span>
                @enderror
            </div>
            ...
            <div class="form-separation">
                ...
                {!! Form::number('userRating', null, ['class' => 'form-control form-number', 'placeholder' => 'Input the title of the movie or TVShow']) !!}
                @error('userRating')
                <span class="form-text-danger">{{$message}}</span>
                @enderror
            </div>
            ...
            <div class="form-separation">
                ...
                {!! Form::number('imdbRating', null, ['class' => 'form-control form-number', 'placeholder' => 'Input the title of the movie or TVShow']) !!}
                @error('imdbRating')
                <span class="form-text-danger">{{$message}}</span>
                @enderror
            </div>
            ...
            <div class="form-separation">
                ...
                {!! Form::text('director', null, ['class' => 'form-control form-text', 'placeholder' => 'Input the title of the movie or TVShow']) !!}
                @error('director')
                <span class="form-text-danger">{{$message}}</span>
                @enderror
            </div>
            ...
            <div class="form-separation">
                ...
                {!! Form::text('videoLink', null, ['class' => 'form-control form-text', 'placeholder' => 'Input the title of the movie or TVShow']) !!}
                @error('videoLink')
                <span class="form-text-danger">{{$message}}</span>
                @enderror
            </div>
